    ...
    app.post('/sign-up/token', async (req, res, next) => {
        ...
        if (find == null && find1 == null) {
            ...
            mail = {
                ...
                body: `<h1>Verify Your email:</h1> <br> <h4>http://localhost:3000/token-verify/${token}</h4> <br> <p>You have 5mins to verify before your link expires</p>`
            }
            sendEmail(mail)
    ...
    app.post('/changepwd', async (req, res) => {
        ...
        if (find == null) {
            ...
            mail = {
                ...
                body: `<h1>Change Your Twiggler Password:</h1> <br> <h4>http://localhost:3000/changepwd/${token}</h4>`
            }
            sendEmail(mail)
            res.send('waiting...')
        }
